...
<div class="container mt-5">
    ...
    <div>
        ...
        <?php
                ...
                echo '<tr align="right">
                        <td colspan="7"><strong>Total em compras:</strong> R$ '.number_format($total_somado,2,',','.').' + R$ 3,50 do boleto</td>
                    </tr></tbody></table>';
        ?>
...
<h3 class="text-info">Confirmação da compra via Boleto</h3><hr/>
<h3>OBSERVAÇÕES</h3>
<h5>Confirmação de pagamento</h5>
<p>Salientamos que devido à necessidade de confirmação do meio de pagamento via boleto junto ao finaceiro, 
...
$(window).load(function() {
 ...
 <?php
 if(isset($_POST['confirma_boleto'])){
...
//$msg= 'Problemas com o SGBD.'.$r->getMessage();
 ...
 <div class="modal fade modal-lg" data-bs-backdrop="static" id="exemplomodal">
  <div class="modal-dialog">
   ...
   <div class="container">
	<p>Sua compra foi resgistrada com sucesso, ela é no valor total de R$ '.number_format(($total_somado + 3.50),2,',','.').', Clique no botão verde para imprimir seu boleto de pagamento. </p>
   <form action="impressao_boleto.php" method="POST" align="center" target="_blank">
	<input type="hidden" name="valor" value="'.$total_somado.'">
	<input type="submit" class="btn btn-success" value="Imprimir Boleto">
	</form>
  
   </div>
   </div>
   <div class="modal-footer bg-light mt-5">

...
if(!empty($_POST)){
	...
	$sql = "SELECT * FROM vendas WHERE id_venda = ?";
		...
		//modificação para chamar o modo de pagamento
		$pagamento=$dados_v['pagamento'];
		$parcelas=$dados_v['parcelas'];
		$data_vencimento=$dados_v['data_vencimento'];
		$desconto=$dados_v['desconto'];
		$total_c_desconto=$dados_v['total_c_desconto'];
...
$doc->ln();
$doc-> SetFont('Arial','bi',12);
$doc->Cell(40,7,'Meio de pagamento: ');
$doc->SetX(52);
$doc-> SetFont('Arial','',12);
$doc->Cell(40,7,$pagamento);
$doc->SetX(88);
$doc-> SetFont('Arial','bi',12);
$doc->Cell(40,7,utf8_decode('N° de parcelas: ').$parcelas);
$doc->SetX(140);
$doc->Cell(40,7,'Vencimento: ');
$doc-> SetFont('Arial','',12);
$doc->SetX(170);
$doc->Cell(40,7,date_format(new DateTime($data_vencimento), "d/m/Y"));
$doc->ln();
$total = (float) $total;
$desconto = (float) $desconto;
$total_c_desconto = (float) $total_c_desconto;
$doc-> SetFont('Arial','bi',12);
$doc->Cell(0,7,'Valor dos Produtos: ');
$doc-> SetFont('Arial','',12);
$doc->SetX(51);
$doc->Cell(0,7,'R$ '.number_format($total,2,'.',','));
$doc-> SetFont('Arial','bi',12);
$doc->SetX(88);
$doc->Cell(0,7,'Desconto: ');
$doc-> SetFont('Arial','',12);
$doc->SetX(110);
$doc->Cell(0,7,'R$ '.number_format($desconto,2,'.',','));
$doc-> SetFont('Arial','bi',12);
$doc->SetX(140);
$doc->Cell(0,7,'TOTAL: ');
$doc-> SetFont('Arial','',12);
$doc->SetX(170);
$doc->Cell(0,7,'R$ '.number_format($total_c_desconto,2,'.',','));
$doc->SetX("0");

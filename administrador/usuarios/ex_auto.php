...
<html lang="pt-br">
  ...
  <div class="card">
    ...
    <div id="collapseThree2" class="collapse" data-parent="#accordion">
	  ...
	  <div class="row">
	  <div class="col-sm-2">
	  <input type="date" name="data_per_ex" class="form-control">
	  </div>
	  <div class="col-sm-2">
	  <input type="submit" value="Enviar" class="btn btn-primary">
	  </div></div>
	  </form>
        <a href="?tempoxcomex=30" class="btn btn-secondary border-info">1 mês</a>
		<a href="?tempoxcomex=60" class="btn btn-secondary border-info">2 meses</a>
		<a href="?tempoxcomex=90" class="btn btn-secondary border-info">3 meses</a>
		<a href="?tempoxcomex=180" class="btn btn-secondary border-info">6 meses</a>
		<a href="?tempoxcomex=270" class="btn btn-secondary border-info">9 meses</a>
		<a href="?tempoxcomex=365" class="btn btn-secondary border-info">1 ano</a>
		<a href="?tempoxcomex=730" class="btn btn-secondary border-info">2 anos</a>
		<a href="?tempoxcomex=1095" class="btn btn-secondary border-info">3 anos</a>
      </div>
    </div>
  </div>

  ...
  <div class="container">
	...
	<div class="card mt-2">
            <div class="card-header">
                <h3 class="text-info">Pesquisa de compras sem a entrega efetuada</h3>
            </div>
            <div class="card-body">
...
$inicio     = ($quantidade_cp * $pagina) - $quantidade_cp;
    $sql_a = "SELECT * FROM compras WHERE autorizado = 1 AND entregue = 0 ORDER BY $org $ord LIMIT ".$inicio.",".$quantidade_cp."";
...
$sqlTotal = "SELECT COUNT(id_compra) AS id FROM compras WHERE autorizado =  1 AND entregue = 0";
  //Executa o SQL

...
<html lang="pt-br">
  ...
  <div class="container">
	...
	<div class="card mt-2">
            ...
            <div class="card-body">
                <h3>Escolha a data para a busca desejada</h3>
                <div class="row">
                <div class="col-sm-4">
				<form class="mt-2">
                <p><strong>Insira o período de pesquisa:</strong></p>
				...
				<div class="row mt-3">
				<div class="col-sm-8">
               <input type="submit" class="btn btn-secondary" value="Pesquisar"></div></div>
                </form>
                </div>
                <div class="col">
				<div class="mt-3">
		...
		<?php
			if(!empty($_GET['data_inicio'])){
				$data_com_inicio = $_GET['data_inicio'];
				if(!empty($_GET['data_final'])){ 
				$data_com_final = $_GET['data_final'];}else{ $data_com_final = date("Y-m-d");}
							
				$sql_2 = "SELECT * FROM compras WHERE data BETWEEN '".$data_com_inicio." 00:00:00' AND '".$data_com_final." 23:59:59'";
					  ...
					  <div class="modal-dialog" >
						<div class="modal-content ">
						  <div class="modal-header bg-info">
							<h3 class="modal-title">Compras efetuadas com data de "'.date_format(new DateTime($data_com_inicio),"d/m/Y").'" até "'.date_format(new DateTime($data_com_final),"d/m/Y").'".</h3>
						   </div>
